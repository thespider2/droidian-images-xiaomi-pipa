...
REMOTE_BASE="${3:-https://media.githubusercontent.com/media/thespider2/droidian-images-xiaomi-pipa/ff8bdbefcffa86f9e791e7fba4a268181279e0fe/android-partitions}"
